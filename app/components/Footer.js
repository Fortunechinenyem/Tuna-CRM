    ...
    <footer className="bg-gray-700 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              TunaCRM is a world-class CRM solution designed to help businesses
              manage their contacts, deals, and sales pipelines efficiently.
            </p>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-purple-600 text-white px-4 py-2 rounded-r-lg hover:bg-blue-700 transition duration-300"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          &copy; {new Date().getFullYear()} TunaCRM. All rights reserved.
        </div>
      </div>
    </footer>
  );
